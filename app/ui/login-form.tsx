            ...
            <form action="#" method="post" className="space-y-4">
              <FieldGroup>
                ...
                <Field>
                  ...
                  <FieldLabel htmlFor="form-password">Password <span className="text-xs text-blue-500 ml-auto hover:underline hover:cursor-pointer">Forgot password?</span></FieldLabel>
                  <Input
                    id="form-password"
                    type="password"
                    placeholder="********"
              ...
              <Button type="submit" className="mt-4 w-full py-2 font-medium hover:opacity-80 hover:cursor-pointer">
                Login
              </Button>
            </form>
          </CardContent>
